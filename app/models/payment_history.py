...
from sqlalchemy import REAL, Date, DateTime, ForeignKey, ForeignKeyConstraint, Integer, String, UniqueConstraint
...
class PaymentHistory(db.Model):
    ...
    subscription_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("subscriptions.subscription_id", ondelete="SET NULL"), nullable=True, index=True)
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["exchange_rates.from_currency", "exchange_rates.to_currency", "exchange_rates.date"],
        ),
    )