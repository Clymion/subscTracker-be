...
- **Data Access**: SQLAlchemy (^2.0.40) is used as the ORM for database interactions, along with Alembic (^1.16.1) for managing database migrations.
...
- **Testing**: The testing framework is `pytest` (^7.0.0), used for both unit and integration tests, with `pytest-cov` (^4.0.0) for coverage reporting.
