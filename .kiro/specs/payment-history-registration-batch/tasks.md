...
- [x] 1. データベースとリポジトリ層の準備 (TDD)
- [x] 1.1 `Subscription`モデルの拡張とマイグレーション
...
- [x] 1.2 `SubscriptionRepository`の拡張
...
- [x] 1.3 `PaymentHistoryRepository`の拡張
...
- [x] 2.2 `PaymentRegistrationBatchService`の基本ロジック実装
